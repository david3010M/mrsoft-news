        ...
        $modules = [
            ...
            'Pulso' => [
                [
                    ...
                    'short_description' => 'El núcleo para la atención: Módulos de Admisión e Historia Clínica integrados.',
                    ...
                    'quote_message' => null,
                    'features' => [
                        ['name' => 'Registro de pacientes y médicos', 'description' => ''],
                        ['name' => 'Gestión de especialidades y consultorios', 'description' => ''],
                        ['name' => 'Historias clínicas digitales', 'description' => ''],
                        ['name' => 'Seguimiento de consultas y tratamientos', 'description' => ''],
                        ['name' => 'Emisión de recetas médicas', 'description' => ''],
                    ],
                ],
                [
                    'name' => 'Caja y Ventas',
                    'short_description' => 'Control y seguimiento del dinero en caja, ingresos, gastos y medios digitales.',
                    ...
                    'quote_message' => null,
                    'features' => [
                        ['name' => 'Registro de ventas por servicios', 'description' => ''],
                        ['name' => 'Venta de medicamentos', 'description' => ''],
                        ['name' => 'Control de caja chica y medios digitales', 'description' => ''],
                    ],
                ],
                [
                    'name' => 'Hospitalización',
                    'short_description' => 'Seguimiento diario de pacientes internados, personal responsable y diagnósticos.',
                    ...
                    'quote_message' => null,
                    'features' => [
                        ['name' => 'Atención diaria de pacientes', 'description' => ''],
                        ['name' => 'Asignación de personal médico', 'description' => ''],
                        ['name' => 'Control de tratamientos y medicinas aplicadas', 'description' => ''],
                    ],
                ],
                [
                    'name' => 'Farmacia',
                    'short_description' => 'Registro de medicamentos, control de almacén y existencias.',
                    ...
                    'quote_message' => null,
                    'features' => [
                        ['name' => 'Control de existencias', 'description' => ''],
                        ['name' => 'Movimientos de entrada y salida', 'description' => ''],
                        ['name' => 'Alertas de stock', 'description' => ''],
                    ],
                ],
                [
                    'name' => 'Facturación Electrónica',
                    'short_description' => 'Declaración automática a los sistemas de SUNAT.',
                    ...
                    'features' => [
                        ['name' => 'Emisión de boletas y facturas', 'description' => ''],
                        ['name' => 'Declaración automática a SUNAT', 'description' => ''],
                        ['name' => 'Formatos digitales para el paciente', 'description' => ''],
                    ],
                ],
            ],
            'Gestiobras' => [
                [
                    'name' => 'Plan Base',
                    'short_description' => 'Incluye el panel central de GESTIOBRA con acceso a todas las herramientas de configuración y administración.',
                    'description' => 'Incluye el panel central de GESTIOBRA con acceso a todas las herramientas de configuración y administración.',
                    'is_featured' => false,
                    'is_required' => true,
                    'monthly' => 90.00,
                    'annual' => 900.00,
                ...
                [
                    ...
                    'short_description' => 'Avances, hitos e inspecciones',
                    'description' => 'Avances, hitos e inspecciones',
                    'is_featured' => false,
                    'is_required' => false,
                    'monthly' => 45.00,
                    'annual' => 450.00,
                    ...
                    'quote_message' => null,
                    'features' => [
                        ['name' => 'Avances por etapa y partida', 'description' => 'Registra el porcentaje de avance de cada partida directamente desde el campo y compáralo contra lo planificado. El equipo de obra actualiza el estado en tiempo real desde el celular, sin planillas intermedias, y oficina técnica ve los cambios al instante. Así detectas desviaciones de plazo antes de que se conviertan en un problema mayor.'],
                        ['name' => 'Cronograma Gantt interactivo', 'description' => 'Visualiza el cronograma completo de la obra en un Gantt interactivo que se actualiza junto con el avance real. Puedes mover hitos, ajustar dependencias entre partidas y ver de inmediato el impacto en la fecha de entrega. Es la misma vista para todo el equipo, evitando versiones distintas del cronograma circulando por correo.'],
                        ['name' => 'Registro fotográfico por obra', 'description' => 'Adjunta fotos y observaciones a cada partida o inspección directamente desde el sitio, con fecha y ubicación registradas automáticamente. Este historial visual sirve como respaldo ante reclamos, auditorías o discrepancias con el cliente. Toda la evidencia queda organizada por obra y por etapa, lista para consultar cuando se necesite.'],
                    ],
                ],
                [
                    'name' => 'Gestión de Personal',
                    'short_description' => 'Cuadrillas, asistencia y contratos',
                    'description' => 'Cuadrillas, asistencia y contratos',
                    'is_featured' => false,
                    'is_required' => false,
                    'monthly' => 40.00,
                    'annual' => 400.00,
                    ...
                    'quote_message' => null,
                    'features' => [
                        ['name' => 'Control de asistencia diaria', 'description' => 'Registra la asistencia de cada trabajador por frente de obra y por turno, sin depender de cuadernos físicos que se pierden o se prestan a errores. El reporte de horas trabajadas queda listo para planillas y para calcular productividad por cuadrilla. Los supervisores marcan la asistencia desde el celular en minutos.'],
                        ['name' => 'Contratos y liquidaciones', 'description' => 'Centraliza los contratos de todo el personal, con fechas de inicio, renovación y vencimiento visibles de un vistazo. Genera liquidaciones automáticamente a partir de la asistencia y los datos del contrato, reduciendo errores manuales de cálculo. Todo el historial queda disponible para auditorías laborales o revisiones internas.'],
                        ['name' => 'Rendimiento por trabajador', 'description' => 'Mide el rendimiento real de cada trabajador y cuadrilla en función del avance logrado frente a las horas trabajadas. Identifica a los equipos más productivos y detecta cuellos de botella antes de que afecten el cronograma general. Esta información te ayuda a asignar mejor al personal en tus próximos proyectos.'],
                    ],
                ],
                [
                    'name' => 'Inventario y Materiales',
                    'short_description' => 'Stock, pedidos y entregas',
                    'description' => 'Stock, pedidos y entregas',
                    'is_featured' => false,
                    'is_required' => false,
                    'monthly' => 30.00,
                    'annual' => 300.00,
                    ...
                    'quote_message' => null,
                    'features' => [
                        ['name' => 'Control de stock en obra', 'description' => 'Ten visibilidad en tiempo real del stock disponible en cada almacén de obra, con entradas y salidas registradas al momento en que ocurren. Evita compras duplicadas o paralizaciones por falta de materiales críticos. Toda la información se actualiza automáticamente sin necesidad de conteos manuales frecuentes.'],
                        ['name' => 'Solicitudes de compra', 'description' => 'Genera y aprueba solicitudes de compra desde la misma plataforma, con flujo de aprobación configurable según el monto o el tipo de material. Elimina las solicitudes por correo o WhatsApp que se pierden entre conversaciones. El historial completo queda disponible para control de costos y auditorías.'],
                        ['name' => 'Alertas de quiebre de stock', 'description' => 'Recibe alertas automáticas cuando un material crítico está por agotarse, según el consumo histórico y el avance previsto de la obra. Esto te da tiempo suficiente para generar el pedido antes de que falte el insumo en campo. Reduce paralizaciones y sobrecostos por compras de emergencia.'],

                    ],
                ],
                [
                    'name' => 'Presupuesto y Costos',
                    'short_description' => 'Presupuesto vs. real en tiempo real',
                    'description' => 'Presupuesto vs. real en tiempo real',
                    'is_featured' => false,
                    'is_required' => false,
                    'monthly' => 40.00,
                    'annual' => 400.00,
                    ...
                    'quote_message' => null,
                    'features' => [
                        ['name' => 'Desvíos automáticos por partida', 'description' => 'Compara automáticamente el presupuesto contra el gasto real de cada partida, sin esperar al cierre de mes para descubrir desviaciones. El sistema resalta las partidas con mayor riesgo de sobrecosto para que puedas actuar a tiempo. Toda la comparación se actualiza junto con los avances registrados en campo.'],
                        ['name' => 'APU digitalizados', 'description' => 'Digitaliza tus Análisis de Precios Unitarios y actualízalos fácilmente conforme cambian los costos de materiales, mano de obra o equipos. Esto mantiene tus proyecciones de costo realistas a lo largo de toda la obra. Además, puedes reutilizar los APU en presupuestos de futuros proyectos.'],
                        ['name' => 'Exportación a Excel/PDF', 'description' => 'Exporta cualquier reporte de presupuesto y costos a Excel o PDF en segundos, con el formato listo para compartir con gerencia, clientes o entidades supervisoras. Ahorra el tiempo que normalmente se pierde armando reportes manualmente. La información exportada siempre refleja el estado más actualizado del sistema.'],

                    ],
                ],
                [
                    'name' => 'Documentación Digital',
                    'short_description' => 'Planos, contratos y permisos',
                    ...
                    'quote_message' => null,
                    'features' => [
                        ['name' => 'Almacenamiento ilimitado', 'description' => 'Guarda planos, contratos, permisos y toda la documentación de tus obras sin preocuparte por límites de espacio. Todo queda organizado por proyecto y accesible desde cualquier dispositivo con conexión a internet. Se acabaron las carpetas físicas y los archivos dispersos en distintas computadoras.'],
                        ['name' => 'Control de versiones', 'description' => 'Cada vez que un documento se actualiza, el sistema conserva las versiones anteriores y deja claro cuál es la vigente. Esto evita confusiones sobre qué plano o contrato corresponde usar en obra. Puedes revisar el historial completo de cambios en cualquier momento.'],
                        ['name' => 'Firma digital de documentos', 'description' => 'Firma contratos y permisos digitalmente sin necesidad de imprimir, escanear ni trasladarte para obtener una firma física. El proceso de aprobación se acelera considerablemente y queda registrado con validez legal. Ideal para equipos que trabajan entre obra, oficina y proveedores externos.'],

                    ],
                ],
                [
                    'name' => 'Reportes y Analytics',
                    'short_description' => 'Dashboards ejecutivos y KPIs',
                    ...
                    'quote_message' => null,
                    'features' => [
                        ['name' => 'Reportes automáticos semanales', 'description' => 'Recibe reportes de avance, costos y productividad directamente en tu correo cada semana, sin necesidad de armarlos manualmente. Esto mantiene informado a todo el equipo directivo sin depender de reuniones o solicitudes puntuales. Los reportes se generan automáticamente a partir de la información ya registrada en el sistema.'],
                        ['name' => 'Dashboard ejecutivo', 'description' => 'Visualiza el estado general de todas tus obras en un solo dashboard, con los indicadores más importantes resumidos de forma clara. Filtra por proyecto, periodo o tipo de indicador según lo que necesites revisar. Es la vista ideal para gerencia, que necesita información precisa sin entrar al detalle operativo.'],
                        ['name' => 'Exportación a PowerPoint', 'description' => 'Exporta cualquier reporte o dashboard a PowerPoint en un clic, listo para presentar ante directorio, inversionistas o clientes. Ahorra horas de trabajo armando presentaciones manualmente cada vez que hay que reportar resultados. El diseño mantiene un formato profesional y consistente en cada exportación.'],
